...
export interface ITicketDocument extends Document, TicketDocumentType, ICreatedUpdatedWithUser {
}
...
export interface IFieldEngineer extends Document, OverriddenFieldEngineerType, ICreatedUpdatedWithUser {
}
export interface IPopulatedFieldEngineer extends Document, Omit<FieldEngineerType, "subtickets"> {
    subtickets: ISubTicket[];
    tickets: ITicket[];
}
export interface PopulatedVendorContact extends Document, Omit<VendorContractType, "billingDetails"> {
...
export interface PopulatedExtension extends Document, Omit<ExtensionType, "schedule" | "subticketId"> {
    schedule: ISchedule;
    subticketId: ISubTicket;
}
export interface PopulatedFieldEngineer extends Document, Omit<FieldEngineerLoginType, "user" | "address"> {
    user: IUser;
    address: IAddress;
}
